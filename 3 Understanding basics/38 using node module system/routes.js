...
const handleRequests = (req, res) => {
	...
	if (url === "/message" && method === "POST") {
		...
		return req.on("end", () => {
			...
			// using writeFile so that the operation becomes event driven.
			// when the file is created and text is added, only then statusCode, header is set, and res.end() is executed
...
module.exports = { handleRequests, printHello };
